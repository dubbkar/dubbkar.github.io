    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item"><a class="nav-link link text-black text-primary display-4" href="https://dubbkar.github.io/movies.html">Anime Movies</a></li><li class="nav-item"><a class="nav-link link text-black display-4" href="https://dubbkar.github.io/Anime_List.html">Anime Series</a></li><li class="nav-item"><a class="nav-link link text-black display-4" href="https://dubbkar.github.io/AboutUs.html">HumLog</a></li></ul>
                <div class="icons-menu">
                    <a class="iconfont-wrapper" href="https://www.facebook.com/dubbkar" target="_blank">
                        <span class="p-2 mbr-iconfont ti-facebook"></span>
                    </a>
                    <a class="iconfont-wrapper" href="https://www.youtube.com/channel/UCi73ErKgzyoxYii2BDyPwQw" target="_blank">
                        <span class="p-2 mbr-iconfont ti-youtube"></span>
                    </a>
                    <a class="iconfont-wrapper" href="https://rzp.io/l/GlUdKmDvpV" target="_blank">
                        <span class="p-2 mbr-iconfont ti-money"></span>
                    </a>
    ...
    <div class="container">
        <div class="row mbr-white">
            <div class="col-12 col-md-6 col-lg-3">
                <h5 class="mbr-section-subtitle mbr-fonts-style mb-2 display-7">What Do we HAVE SPECIAL !?<br>- All Full Episodes<br>- Anime Movies<br>- Anime Series<br>- Ads Free Version<br>only on dubbKar</h5>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                ...
                <div class="social-row display-7">
                    <div class="soc-item">
                        <a href="https://www.youtube.com/channel/UCi73ErKgzyoxYii2BDyPwQw" target="_blank">
                            <span class="mbr-iconfont ti-youtube"></span>
                        </a>
                    </div>
                    <div class="soc-item">
                        <a href="https://www.facebook.com/dubbkar" target="_blank">
